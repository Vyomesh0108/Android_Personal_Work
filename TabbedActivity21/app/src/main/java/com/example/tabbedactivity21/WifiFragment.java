...
public class WifiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tv = view.findViewById(R.id.tvSecond);
        btOn = view.findViewById(R.id.wifion);
        btOff = view.findViewById(R.id.wifioff);
        wifiman = (WifiManager) getActivity().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
